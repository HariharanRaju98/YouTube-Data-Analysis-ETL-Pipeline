...
job_flow_overrides = {
    ...
    "Instances": {
        ...
        "Ec2SubnetId": *,               #put your subnet ID here
        "Ec2KeyName" : 'emr-keypair-airflow', #put the EMR key pair here
...
SPARK_STEPS_TRANSFORMATION = [
    {
        "Name": "Transform youtube data",
        "ActionOnFailure": "CANCEL_AND_WAIT",
        "HadoopJarStep": {
            "Jar": "command-runner.jar",
            "Args": ["spark-submit",
            "s3://youtube-data-analyis-project/scripts/transform_youtube.py",
            ],
        },
    },
   ]
...
with DAG('youtube_data_analyis_spark_job_dag',
        ...
        start_pipeline >> create_emr_cluster >> is_emr_cluster_created >>  add_transformation_step >> is_transformation_completed
